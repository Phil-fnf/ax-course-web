...
function AiIcon() {
  return (
    <div className="w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-[#330000] flex items-center justify-center flex-shrink-0 shadow-lg">
      <span className="font-mono text-[#FF9A00] text-2xl md:text-3xl font-bold tracking-tight">Ai</span>
    </div>
  )
}
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <motion.p
        ...
        className="absolute top-8 left-8 text-sm text-text-secondary font-mono"
      >
        F&F&nbsp;&nbsp;AX&nbsp;&nbsp;전상필 담당
      </motion.p>
